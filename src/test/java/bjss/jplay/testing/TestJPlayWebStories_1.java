...
import bjss.jplay.steps.LoginSteps;
...
public class TestJPlayWebStories_1 extends JUnitStories {
    ...
    protected List<String> storyPaths() {
        return Arrays.asList("bjss/jplay/automation/stories/loginTest.story");
    }
